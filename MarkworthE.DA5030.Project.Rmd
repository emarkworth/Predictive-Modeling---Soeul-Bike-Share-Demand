...
```
I am imputing the data by median, as mean imputation would further skew the data for features not normally distributed.
...
```
I am using the `rpart` function in the rpart package to create my decision tree model. An alternative package I could use is `RWeka` but I find it less intuitive in the way it handles the data its fed.
